...
export const getTechIcon = (techName) => {
  const techIcons = {
    ...
    'HTML': (
      <svg viewBox="0 0 24 24" className="w-6 h-6">
        <rect width="20" height="20" x="2" y="2" fill="#E34F26" rx="3" />
        <text
          x="12"
          y="16"
          fontSize="7"
    ...
    'CSS': (
      <svg viewBox="0 0 24 24" className="w-6 h-6">
        <rect width="20" height="20" x="2" y="2" fill="#1572B6" rx="3" />
        <text
          x="12"
          y="16"
          fontSize="8"
    ...
    'Firebase': (
      <svg viewBox="0 0 24 24" className="w-6 h-6">
        <rect width="20" height="20" x="2" y="2" fill="#FFCA28" rx="3" />
        <text
          x="12"
          y="16"
          fontSize="7"
    ...
    'OAuth': (
      <svg viewBox="0 0 24 24" className="w-6 h-6">
        <rect width="20" height="20" x="2" y="2" fill="#2563EB" rx="3" />
        <text
          x="12"
          y="16"
          fontSize="7"
